...
const Product = () => {
  ...
  // Memoize the handleLoadMore function to avoid unnecessary re-renders
          ...
          {visibleProducts < products.length && (
            <div className="text-center mt-8">
              <button
                ...
                className="px-6 w-56 py-3 bg-orange-500 text-white rounded-sm hover:bg-orange-600 transition-colors"
              >
                Load More
              </button>
            </div>
